...
class FeedBackController extends Controller
{
    ...
    {
        $assign['feed_backs'] = DB::select('SELECT (SELECT nickname FROM users WHERE users.id = feed_backs.F_user_Id) AS nickname,F_content,F_date FROM feed_backs WHERE F_related_Id is null ORDER BY id DESC');
